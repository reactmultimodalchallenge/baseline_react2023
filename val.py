...
def parse_arg():
    ...
    parser.add_argument('--outdir', default="./results/val", type=str, help="result dir")
...
def main(args):
    ...
    print("val_loss: {:.5f}   val_rec_loss: {:.5f}  val_kld_loss: {:.5f} ".format(val_loss, rec_loss, kld_loss))
