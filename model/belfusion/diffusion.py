...
class LatentDiffusion(GaussianDiffusion):
    ...
    def ddim_sample_loop_progressive(
        ...
        """
        # ---------
        shape = (batch_size, matcher.get_emb_size())
        obs_orig = model_kwargs["cond"]
        ...
        for i in indices:
            ...
            with th.no_grad():
                ...
                out = {
                    ...
                    "encoded_target": gt_emb,
                    "prediction": matcher.decode_emotion(out["pred_xstart"]),
                    "target": gt_emb_decoded,
